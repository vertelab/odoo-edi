...
pwd = 'admin'
dbname = 'greenvision'  # This is the test-database for now
...
res = sock.execute(dbname, uid, pwd, 'ica.label', 'write', sock.execute(dbname, uid, pwd, 'ica.label', 'search',[]),{'completed': 1 })
