...
class ica_edi_partner(osv.osv):
    ...
    _columns = {
        ...
        'partnertype': fields.selection((('1','Kvantum'),('2','Maxi'),('3','Supermarket'),('4','Cura Apotek'),('5','Ica Nära'),('6','Ica ToGo'),('98','Depå'),('99','Övrigt')), 'Butikstyp', size=11),
    }
    _defaults = {
        'partnertype': lambda *a: '1',
    }
ica_edi_partner()
...
class ica_edi_product(osv.osv):
    ...
    _columns = {
        ...
        'utskriftsgrupp': fields.selection((('1','1 Delad frukt'),('2','2 Tråg/flowpack'),('3','3 1000 ml juice'),('4','4 350 ml juice'),), 'Utskriftsgrupp', size=10),
