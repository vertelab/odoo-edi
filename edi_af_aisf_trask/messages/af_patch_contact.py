    ...
    def pack(self):
        if self.edi_type.id == self.env.ref("edi_af_aisf_trask.asok_contact").id:
            ...
            if obj.last_contact and obj.last_contact_type:
                data_dict[
                    "senasteKontaktTyp"
                ] = obj.last_contact_type  # Possible values: B, T, E, P, I
                data_dict[
                    "senasteKontaktDatum"
                ] = obj.last_contact_date  # "2019-10-02",
            if obj.next_contact:
                data_dict["nastaKontaktTyper"] = [
                    "%s" % obj.next_contact_type
                ]  # Possible values: B, T, E, P, I
                data_dict["nastaKontaktDatum"] = obj.next_contact_date  # "2019-12-31",
