...
class ipf_rest(_ipf):
    ...
    def get(self, message):
        ...
        elif message.edi_type in [message.env.ref('edi_af_aisf_trask.asok_office', raise_if_not_found=False), message.env.ref('edi_af_aisf_trask.asok_patch_office', raise_if_not_found=False), message.env.ref('edi_af_aisf_trask.asok_contact', raise_if_not_found=False)]:
