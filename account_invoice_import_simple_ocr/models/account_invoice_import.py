...
class AccountInvoiceImport(models.TransientModel):
    ...
    def simple_pdf_text_extraction(self, file_data, test_info):
        _logger.warning(
            "OVERRIDEN simple_pdf_text_extraction !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    ...
    def _simple_pdf_text_extraction_pytesseract(self, fileobj, test_info):
        ...
        _logger.warning(
            f"\n\n* Text extraction made with pytesseract - Module: account_invoice_import_simple_ocr.py - Caller: {caller_name} *\n\n"
        )
...
#         _logger.warning(
#             "account_invoice_import_simple_ocr          def simple_pdf_text_extraction(self, file_data, test_info)" * 10)
...
#     @api.model
#     def _simple_pdf_text_extraction_pytesseract(self, fileobj, test_info):
#         _logger.warning("account_invoice_import_simple_ocr       def _simple_pdf_text_extraction_pytesseract(self, fileobj, test_info):"*10)
#         res = False
#         try:
#             pages = []
